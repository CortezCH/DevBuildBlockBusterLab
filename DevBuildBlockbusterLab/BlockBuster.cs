...
namespace DevBuildBlockbusterLab
{
    class BlockBuster
    {
        ...
        {
            new DVD("The Lord of the Ring: Fellowship of the Ring", "Romance", 178, new List<string> {"A wizard is never late, Frodo Baggins. Nor is he early. He arrives precisely when he means to.",
            ...
            new DVD("The Lord of the Ring: Twin Towers", "Drama", 179, new List<string> {"They're taking the hobbits to Isengard.",
                "Saruman!",
            ...
            new DVD("The Lord of the Ring: Return of the King", "Horror", 201, new List<string> {"I am no MAN!",
            ...
            new VHS("The Hobbit: An Unexpected Journey", "Comedy", 169, new List<string> {"True courage is not knowing when to take a life, but when it spare it.",
            ...
            new VHS("The Hobbit: The Desolation of Smaug", "Action", 161, new List<string> {" Come out. Don't be shy. Step into the light.",
            ...
            new VHS("The Hobbit: The Battle of the Five Armies", "Romance", 144, new List<string> {"You have no place here! You are nameless! Go back to the shadow from whence you came!",
